...
describe('computePairAddress', () => {
  it('should correctly compute the pool address', () => {
    const tokenA = new Token(ChainId.FXCORE, '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', 18, 'USDC', 'USD Coin')
    const tokenB = new Token(ChainId.FXCORE, '0x6B175474E89094C44Da98b954EedeAC495271d0F', 18, 'DAI', 'DAI Stablecoin')
  ...
  it('should give same result regardless of token order', () => {
    ...
    const DAI = new Token(ChainId.FXCORE, '0x6B175474E89094C44Da98b954EedeAC495271d0F', 18, 'DAI', 'DAI Stablecoin')
    let tokenA = USDC
    let tokenB = DAI
...
describe('Pair', () => {
      ...
      expect(
        () =>
          new Pair(
            ...
            CurrencyAmount.fromRawAmount(WETH9[ChainId.DHOBYGHAUT], '100')
          )
      ).toThrow('CHAIN_IDS')
    })
  })
  ...
  describe('#priceOf', () => {
    ...
    it('throws if invalid token', () => {
      expect(() => pair.priceOf(WETH9[ChainId.FXCORE])).toThrow('TOKEN')
    })
  })
  ...
  describe('miscellaneous', () => {
    it('getLiquidityMinted:0', async () => {
      const tokenA = new Token(ChainId.DHOBYGHAUT, '0x0000000000000000000000000000000000000001', 18)
      const tokenB = new Token(ChainId.DHOBYGHAUT, '0x0000000000000000000000000000000000000002', 18)
